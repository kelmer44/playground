...
/**
 * Marks a ViewModel as Fragment scoped in order for annotation processor to generate a Dagger module for it.
...
public @interface FragmentViewModel {
     ...
     * <p>b) after the fragment's onCreate</p>
     *
     * <p>Therefore, injection of the ViewModel on the Fragment must be wrapped with dagger.Lazy.</p>
     *
